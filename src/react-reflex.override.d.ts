declare module "react-reflex" {
  ...
  export class ReflexContainer extends React.Component<PropsWithChildren<ReflexContainerProps>, any> {}
  ...
  export class ReflexElement extends React.Component<PropsWithChildren<ReflexElementProps>, any> {}
  ...
  export class ReflexSplitter extends React.Component<PropsWithChildren<ReflexSplitterProps>, any> {}
